...
import static core.HttpContext.CR;
import static core.HttpContext.LF;
...
public class HttpServletResponse {
    ...
    public void setContentFile(File contentFile) {
        ...
        String mine = HttpContext.getMimeType(nameSplit);
        addHeaders("Content-Type", mine);
